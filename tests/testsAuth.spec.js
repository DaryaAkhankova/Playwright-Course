...
JSON.stringify(require('../test-data/TestDataAuth.json')));
...
test.describe('Tests for checking registration', () => {
  ...
  test('check that user is successfully registered from the login page', async () => {
  ...
  test('check that user is successfully registered from the forgot password page', async () => {
  ...
  test('check that already created user cannot register', async () => {
    await element.registrationPage.registration(
      dataSet.userFirstName,
      dataSet.userLastName,
      dataSet.userEmail,
  ...
  test('check that user cannot register without filling in required fields', async () => {
  ...
  test('check that user cannot register without populating Last Name field', async () => {
  ...
  test('check that user cannot register without checking required checkbox', async () => {
  ...
  test('validating First Name when the length of the field is less than the minimum', async () => {
    await element.registrationPage.registration(
  ...
  test('validating First Name field exceeding the max allowed length', async () => {
    await element.registrationPage.registration(
  ...
  test('validating Last Name when the length of the field is less than the minimum', async () => {
    await element.registrationPage.registration(
      dataSet.userFirstName,
  ...
  test('validating Last Name field exceeding the max allowed length', async () => {
    await element.registrationPage.registration(
      dataSet.userFirstName,
  ...
  test('check that user cannot register with existing email', async () => {
    await element.registrationPage.registration(
      dataSet.userFirstName,
      dataSet.userLastName,
      dataSet.userEmail,
  ...
  test('check that user cannot register with invalid email', async () => {
    await element.registrationPage.registration(
      dataSet.userFirstName,
      dataSet.userLastName,
  ...
  test('validating Email field exceeding the max allowed length', async () => {
    await element.registrationPage.registration(
      dataSet.userFirstName,
      dataSet.userLastName,
      dataSet.userInvalidEmail,
  ...
  test('validating Phone Number when the length of the field is less than the minimum', async () => {
    await element.registrationPage.registration(
      dataSet.userFirstName,
      dataSet.userLastName,
      dataSet.userEmail,
  ...
  test('validating Phone Number field exceeding the max allowed length', async () => {
    await element.registrationPage.registration(
      dataSet.userFirstName,
      dataSet.userLastName,
      dataSet.userEmail,
  ...
  test('check that user cannot register with invalid phone number', async () => {
    await element.registrationPage.registration(
      dataSet.userFirstName,
      dataSet.userLastName,
      dataSet.userEmail,
  ...
  test('validating Password fields when the length of the fields is less than the minimum', async () => {
    await element.registrationPage.registration(
      dataSet.userFirstName,
      dataSet.userLastName,
      dataSet.userEmail,
  ...
  test('check that user cannot register when entering password without special characters', async () => {
    await element.registrationPage.registration(
      dataSet.userFirstName,
      dataSet.userLastName,
      dataSet.userEmail,
  ...
  test('check that user cannot register when entering password without numbers', async () => {
    await element.registrationPage.registration(
      dataSet.userFirstName,
      dataSet.userLastName,
      dataSet.userEmail,
  ...
  test('check that user cannot register when entering password without capital letters', async () => {
    await element.registrationPage.registration(
      dataSet.userFirstName,
      dataSet.userLastName,
      dataSet.userEmail,
  ...
  test('check that user cannot register when password and password confirmation are different', async () => {
    await element.registrationPage.registration(
      dataSet.userFirstName,
      dataSet.userLastName,
      dataSet.userEmail,
...
test.describe('Tests for checking log in', () => {
  ...
  test('check that user is successfully logged in from the login page', async ({ page }) => {
    await element.loginPage.userName.type(dataSet.userEmail);
    await element.loginPage.password.type(dataSet.userPassword);
  ...
  test('check that the user cannot login with empty email', async () => {
    await element.loginPage.password.type(dataSet.userPassword);
    await element.loginPage.signInbutton.click();
    await expect(element.loginPage.errorMessage).toHaveText('*Email is required');
  });

  test('check that error message is displayed when entering incorrect format of email and valid password', async () => {
  ...
  test('check that the user cannot login with empty password', async () => {
    await element.loginPage.userName.type(dataSet.userEmail);
    await element.loginPage.signInbutton.click();
    await expect(element.loginPage.errorMessage).toHaveText('*Password is required');
  });

  test('check that the user cannot login with invalid email and valid password', async () => {
  ...
  test('check that the user cannot login with invalid password and valid email', async () => {
    await element.loginPage.userName.type(dataSet.userEmail);
  ...
  test('check that the user cannot login with spaces before password and valid email', async () => {
    await element.loginPage.userName.type(dataSet.userEmail);
  ...
  test('check that the user cannot login with spaces after password and valid email', async () => {
    await element.loginPage.userName.type(dataSet.userEmail);
  ...
  test('check that the user cannot login with invalid email and password', async () => {
    await element.loginPage.userName.type(dataSet.invalidUsername);
    await element.loginPage.password.type(dataSet.invalidPassword);
    await element.loginPage.signInbutton.click();
    await expect(element.loginPage.allertMessage).toHaveText(' Incorrect email or password. ');
...
test.describe('Tests for checking forgot password feature', () => {
  ...
  test('check that user cannot save new password without filling in required fields', async () => {
    await element.forgotPasswordPage.savePasswordButton.click();
  ...
  test('check that non-existent user cannot save new password', async () => {
    await element.forgotPasswordPage.emailField.type(dataSet.invalidUsername);
    await element.forgotPasswordPage.passwordField.type(dataSet.userPassword);
    await element.forgotPasswordPage.confirmPasswordField.type(dataSet.userPassword);
    await element.forgotPasswordPage.savePasswordButton.click();
    await expect(element.forgotPasswordPage.allertMessage).toHaveText(' User Not found. ');
  });

  test('check that user cannot save new password when password and password confirmation are different', async () => {
    await element.forgotPasswordPage.emailField.type(dataSet.userEmail);
    await element.forgotPasswordPage.passwordField.type(dataSet.userPassword);
  ...
  test('check that user cannot login with the old password', async () => {
    await element.forgotPasswordPage.loginButton.click();
    await element.loginPage.userName.type(dataSet.userEmail);
    await element.loginPage.password.type(dataSet.userPassword);
    await element.loginPage.signInbutton.click();
